## Driver's and passengers' A C
***
### Definitions

Abbreviation | Meaning
------------ | -------
*FX*, *AX*| Function and attribute labels, as per the [overview](./Manual#overview).
...
The script implements three, or for clarity's sake, one *unconditionally* and two *conditionally* A/C-based functions. Two of them, the *driver's* and *passengers' A/C*, have much in common, and will therefore be discussed jointly in this section. As already hinted, the *A/C* component of the functions' names is not to be interpreted as the function necessarily being dependent on / using an actual A/C unit at all times.
...
### Output temperature - Driver's A/C
...
### Output temperature - Passengers' A/C
...
### Output humidity volume - Driver's A/C
